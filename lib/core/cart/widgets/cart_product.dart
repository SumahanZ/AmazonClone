import 'package:amazon_app/core/cart/services/cart_services.dart';
...
class _CartProductState extends State<CartProduct> {
  final productDetailServices = ProductDetailsService();
  ...
  Widget build(BuildContext context) {
    //take product in cart of a specific index
    //trigger the rebuild because it is watching
    final productCart = context.watch<UserNotifier>().user.cart[widget.index];
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Text("In Stock",
                        style: TextStyle(color: Colors.teal), maxLines: 2),
                  ),
                ],
              )
            ],
