...
import 'package:amazon_app/core/cart/widgets/cart_product.dart';
import 'package:amazon_app/core/cart/widgets/cart_subtotal.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: CustomButton(color: Colors.yellow.shade600, text: "Proceed to Buy (${user.cart.length} items)", onTap: (){
